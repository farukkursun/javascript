...
//!sil butonu tıklandığında (ul listelerinde silme metodu olan removeChild)
...
document.querySelector(".language").onkeydown = (tus) => {
  ...
  //*eğer delete =46 control=17 shift=16 tuşuna basılırsa sil butonu tetiklensin
  if (tus.keyCode === 16) {
...
liste.innerHTML =
  `<h1 class="a "> ${"Programlama Dilleri"}</h1>` + liste.innerHTML;
